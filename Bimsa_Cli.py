...
def main() -> int:
    ...
    # Requeridos
    p.add_argument("--tipo", required=True, help="Tipo de reporte (ej: CLASICO, OBRAS, CONTACTOS, MAPAS, PROSPECCION)")
    ...
    # Filtros de fecha (metadata reporte)
    p.add_argument("--tipo-fecha", default=None, help="Tipo de fecha usada en el filtro (ej: Fecha Publicación)")
    p.add_argument("--fecha-inicio", default=None, help="Fecha inicial del filtro")
    p.add_argument("--fecha-fin", default=None, help="Fecha final del filtro")
    # Entrada XML
